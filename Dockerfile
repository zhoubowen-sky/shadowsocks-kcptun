...
ENV KCPTUN_URL=https://github.com/xtaci/kcptun/releases/download/v20201010/kcptun-linux-amd64-20201010.tar.gz
ENV V2RAY_URL=https://github.com/v2fly/v2ray-core/releases/download/v4.31.1/v2ray-linux-64.zip
